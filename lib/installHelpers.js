...
var logUpdate = require('log-update').default;
var mailer = require('./mailer');
var path = require('path');
var readline = require('readline');
var needle = require('needle');

// minimal GET helper with a request-style callback (error, response, body)
function request(options, callback) {
  needle.get(options.uri, { headers: options.headers, parse: false }, (error, response, body) => callback(error, response, body));
}
