...
exports = module.exports = {
  ...
  postAsset: function (req, res, next) {
    ...
    form.parse(req, function (error, fields, files) {
      function findValueByType(type){
        var mimekey = type.split('/')[0];
        return configuration.getConfig(`mimeTypesCustomUploadSize_${mimekey}`) || null;
      }

      var maxUpload = bytes(findValueByType(form.openedFiles[0].type));
      if (maxUpload === null){
