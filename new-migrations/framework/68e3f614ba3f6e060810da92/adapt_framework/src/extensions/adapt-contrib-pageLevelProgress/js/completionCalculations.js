define([
    ...
    function calculateCompletion(contentObjectModel) {
        ...
        switch (viewType) {
            case 'page':
                // If it's a page
                var childrenComponents = contentObjectModel.findDescendantModels('components',  {
                    where: {
                        _isAvailable: true,
                        _isOptional: false
                    }
                ...
                var childrenBlocks = contentObjectModel.findDescendantModels('blocks',  {
                    where: {
                        _isAvailable: true,
                        _isOptional: false
                    }
                ...
                children = childrenComponents.concat(childrenBlocks);
