...
define('components/adapt-hotgrid/js/hotgridPopupView',[
    'core/js/adapt'
], function(Adapt) {
    'use strict';
...
define('components/adapt-hotgrid/js/hotgridView',[
    'core/js/adapt',
    'core/js/views/componentView',
    './hotgridPopupView'
...
define('theme/68e3f6ecba3f6e060810dab2/js/esdc',['require','coreJS/adapt','backbone','theme/adapt-contrib-vanilla/js/theme-block'],function(require) {
...
;
define("plugins", ["components/adapt-contrib-accordion/js/adapt-contrib-accordion","components/adapt-contrib-gmcq/js/adapt-contrib-gmcq","components/adapt-contrib-graphic/js/adapt-contrib-graphic","components/adapt-contrib-hotgraphic/js/adapt-contrib-hotgraphic","components/adapt-contrib-matching/js/adapt-contrib-matching","components/adapt-contrib-mcq/js/adapt-contrib-mcq","components/adapt-contrib-media/js/adapt-contrib-media","components/adapt-contrib-narrative/js/adapt-contrib-narrative","components/adapt-contrib-openTextInput/js/adapt-contrib-openTextInput","components/adapt-contrib-slider/js/adapt-contrib-slider","components/adapt-contrib-text/js/adapt-contrib-text","components/adapt-esdc-tour/js/adapt-esdc-tour","components/adapt-hotgrid/js/adapt-hotgrid","components/adapt-quicknav/js/adapt-quicknav","extensions/Adapt-accessibilityfixes/js/adapt-mathJax","extensions/adapt-contrib-bookmarking/js/adapt-contrib-bookmarking","extensions/adapt-contrib-glossary/js/adapt-contrib-glossary","extensions/adapt-contrib-pageLevelProgress/js/adapt-contrib-pageLevelProgress","extensions/adapt-contrib-resources/js/adapt-contrib-resources","extensions/adapt-contrib-spoor/js/adapt-contrib-spoor","extensions/adapt-contrib-trickle/js/adapt-contrib-trickle","extensions/adapt-contrib-tutor/js/adapt-contrib-tutor","extensions/adapt-esdc-i18n/js/adapt-esdc-i18n","extensions/adapt-homeButton/js/adapt-homeButton","extensions/adapt-pageIncompletePrompt/js/adapt-pageIncompletePrompt","extensions/adapt-search/js/adapt-search","menu/adapt-contrib-boxMenu/js/adapt-contrib-boxmenu","theme/68e3f6ecba3f6e060810dab2/js/esdc"], function(){});
